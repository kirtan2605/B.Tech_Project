...
disp(['Wn1 (closed-loop orbit rate): ', num2str(Solution_Wn1)]);
disp(['Wn2 (closed-loop nutation frequency): ', num2str(Solution_Wn2)]);
disp(['open-loop nutation frequency : ', num2str(h/(sqrt(Ix*Iz)))])
disp(" ");
